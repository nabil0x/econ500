...
• Formulas in clean notation (∂, α, β, ⇔, ≤, ≥, ∫, ½, √)
• Where applicable: tables, comparison matrices, payoff matrices
• **Exam Tip** → common mistakes, marking points, things to always include
```

### Where Answers Come From

Source material is all 18 extracted text files in `resources/extracted_text/`, including:
- **Koutsoyiannis** — Modern Microeconomics (238K words, full textbook)
- **Munoz-Garcia** — Advanced Microeconomic Theory (286K words, full textbook)
- **Chapter PDFs** — Preferences, Choice, Demand, Demand Apps, Production (45K words)
- **Welfare sheets** — CV/EV/CS reference material (81K words)
- **GE papers** — Path to GE, Static Properties of GE
- **Professor question sets** — 17 + 49 questions provided by professor
