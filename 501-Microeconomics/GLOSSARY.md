...
| **AC** | Average Cost | Total cost per unit of output: $AC(Q) = TC(Q)/Q$; U-shaped under perfect competition | [DP 3C.Q1](./answers-demand-production.md#q-compet-01) |
<a id="term-avc"></a>
<a id="term-average-variable-cost"></a>
| **AVC** | Average Variable Cost | Variable cost per unit: $AVC(Q) = TVC(Q)/Q$; shutdown condition: $P \ge \min AVC$ | [DP 3A.Q7](./answers-demand-production.md#q-prodset-07) |
<a id="term-cmp"></a>
| **CMP** | Cost Minimization Problem | Production dual to PMP: $\min_{z\ge0} w\cdot z$ s.t. $f(z)\ge q$ → conditional factor demands, cost fn $c(w,q)$ | [DP 3A.Q5–Q7](./answers-demand-production.md#q-prodset-05) |
<a id="term-crs"></a>
<a id="term-crts"></a>
| **CRS** / **CRTS** | Constant Returns to Scale | $f(tx) = tf(x)$ for all $t > 0$; doubling inputs doubles output; $AC = MC$ constant | [DP 3A.Q1](./answers-demand-production.md#q-prodset-01), [basics.md](./basics.md) |
<a id="term-drs"></a>
<a id="term-drts"></a>
| **DRS** / **DRTS** | Decreasing Returns to Scale | $f(tx) < tf(x)$ for all $t > 0$; doubling inputs less than doubles output; $AC \uparrow$ with $Q$ | [DP 3A.Q7](./answers-demand-production.md#q-prodset-07), [basics.md](./basics.md) |
<a id="term-irs"></a>
<a id="term-irts"></a>
| **IRS** / **IRTS** | Increasing Returns to Scale | $f(tx) > tf(x)$ for all $t > 0$; doubling inputs more than doubles output; $AC \downarrow$ with $Q$ (economies of scale) | [DP 3A.Q1](./answers-demand-production.md#q-prodset-01), [basics.md](./basics.md) |
<a id="term-ivt"></a>
| **IVT** | Intermediate Value Theorem | If $f$ is continuous on $[a,b]$ and $f(a) < 0 < f(b)$, then $\exists c \in (a,b): f(c) = 0$; used to prove GE existence | [GE 6A.Q2](./answers-ge-game-extern-trade.md#q-ge-02), [§8](#term-intermediate-value-theorem) |
<a id="term-k"></a>
<a id="term-capital"></a>
| **K** | Capital | Produced factor of production; earned return $r$ (rental rate); used alongside labour L | [DP 3A](./answers-demand-production.md) |
<a id="term-l"></a>
<a id="term-labour"></a>
...
| **MC** | Marginal Cost | Cost of producing one more unit: $MC(Q) = dTC/dQ$; supply curve = MC above min AVC | [DP 3C.Q1](./answers-demand-production.md#q-compet-01), [basics.md](./basics.md) |
<a id="term-med"></a>
| **MED** | Marginal External Damage | Additional harm from one more unit of pollution/externality; optimal Pigouvian tax $t = MED$ at $Q^*$ | [GE 8.Q2](./answers-ge-game-extern-trade.md#q-extern-02), [§7](#term-pigouvian-tax) |
<a id="term-meb"></a>
| **MEB** | Marginal External Benefit | Additional benefit from one more unit of positive externality; optimal Pigouvian subsidy $s = MEB$ at $Q^*$ | [WF 5B.Q4](./answers-welfare.md#q-pareto-04), [§7](#term-positive-externality) |
<a id="term-mp"></a>
<a id="term-marginal-product"></a>
| **MP** | Marginal Product | Additional output from one more unit of input: $MP_L = \partial f(K,L)/\partial L$, $MP_K = \partial f(K,L)/\partial K$ | [DP 3A.Q4](./answers-demand-production.md#q-prodset-03) |
<a id="term-mu"></a>
<a id="term-marginal-utility"></a>
| **MU** | Marginal Utility | Additional utility from one more unit of good: $MU_k = \partial u(x)/\partial x_k$; FOC: $MU_k = \lambda p_k$ | [CT 1A.Q9](./answers-consumer-theory.md#q-cons-09), [CT 1B.Q1](./answers-consumer-theory.md#q-cons-1b-01) |
<a id="term-pbe"></a>
<a id="term-perfect-bayesian"></a>
| **PBE** | Perfect Bayesian Equilibrium | NE in dynamic games of incomplete information: strategies optimal given beliefs, beliefs consistent with Bayes' rule on-path | [GE 8.Q4](./answers-ge-game-extern-trade.md#q-extern-04) |
<a id="term-pmc"></a>
| **PMC** | Private Marginal Cost | Marginal cost borne by the producer; excludes external damage; $PMC + \text{tax} = SMC$ under Pigouvian correction | [GE 8.Q2](./answers-ge-game-extern-trade.md#q-extern-02), [basics.md](./basics.md) |
<a id="term-ps"></a>
...
| **SOC** | Second-Order Condition | Curvature condition ensuring FOC solution is max/min; for UMP: $| \overline{H} | \ge 0$ (bordered Hessian test) | [CT 1A.Q9](./answers-consumer-theory.md#q-cons-09) |
<a id="term-sr"></a>
<a id="term-short-run"></a>
| **SR** | Short Run | At least one factor fixed; firms can shut down but not exit; supply = MC above min AVC | [DP 3A.Q7](./answers-demand-production.md#q-prodset-07), [DP 3C](./answers-demand-production.md) |
<a id="term-tc"></a>
<a id="term-total-cost"></a>
<a id="term-transaction-costs"></a>
| **TC** | Total Cost / Transaction Costs | (i) $TC = FC + VC$; or (ii) Costs of exchange (search, bargaining, enforcement) — zero TC assumed in Coase theorem | [DP 3A.Q7](./answers-demand-production.md#q-prodset-07), [GE 8.Q2](./answers-ge-game-extern-trade.md#q-extern-02) |
<a id="term-tr"></a>
<a id="term-total-revenue"></a>
| **TR** | Total Revenue | $TR = P \times Q$; total revenue test: $|\varepsilon| > 1 \Rightarrow P \downarrow \Rightarrow TR \uparrow$ | [DP 2.Q1](./answers-demand-production.md#q-demand-01), [EXAM-CHEAT-SHEET.md](./EXAM-CHEAT-SHEET.md) |
<a id="term-wtp"></a>
<a id="term-willingness-to-pay"></a>
| **WTP** | Willingness to Pay | Maximum price a consumer will pay for a good; demand curve = marginal WTP; drives lemons market failure | [GE 8.Q3](./answers-ge-game-extern-trade.md#q-extern-03) |
...
| **Arrow's Impossibility Theorem** | (1951) No SWF can simultaneously satisfy universal domain, Pareto efficiency, independence of irrelevant alternatives, and non-dictatorship | [WF 5A.Q6](./answers-welfare.md#q-socwel-06) |
<a id="term-bergson-samuelson"></a>
| **Bergson-Samuelson SWF** | $W = W(u_1,\dots,u_n)$ with explicit value judgements; used for social optimisation (contrast with Arrow's aggregation approach) | [WF 5A.Q6](./answers-welfare.md#q-socwel-06), [WF 5B.Q1](./answers-welfare.md#q-pareto-01) |
<a id="term-chain-store-paradox"></a>
| **Chain-Store Paradox** | In finitely repeated entry game, backward induction predicts entry always; but reputation can sustain deterrence in practice | [GE 7.Q5](./answers-ge-game-extern-trade.md#q-game-05), [EXAM-COMMON-MISTAKES.md](./EXAM-COMMON-MISTAKES.md) |
<a id="term-compensated-law-demand"></a>
| **Compensated Law of Demand** | $\partial h_k(p,u)/\partial p_k \le 0$ — Hicksian demand slopes downward (non-positive own-price effect); follows from NSD of Slutsky matrix | [CT 1B.Q4](./answers-consumer-theory.md#q-cons-1b-04) |
<a id="term-euler-theorem"></a>
| **Euler's Theorem** | If $f$ is HD($r$), then $\sum_k \partial f/\partial x_k \cdot x_k = r f(x)$; for CRTS: $f = f_K K + f_L L$ (product exhaustion) | [DP 3A.Q1](./answers-demand-production.md#q-prodset-01) |
<a id="term-fixed-point"></a>
<a id="term-brouwer"></a>
<a id="term-kakutani"></a>
| **Fixed Point Theorems** (Brouwer/Kakutani) | Continuous function mapping compact convex set to itself has a fixed point $x = f(x)$; used to prove Arrow-Debreu GE existence | [GE 6A.Q2](./answers-ge-game-extern-trade.md#q-ge-02) |
<a id="term-gross-substitutes"></a>
| **Gross Substitutes Condition** | $\partial z_i(p)/\partial p_j > 0$ for all $i \ne j$; sufficient (but not necessary) for uniqueness of GE | [GE 6A.Q3](./answers-ge-game-extern-trade.md#q-ge-03) |
<a id="term-stolper-samuelson"></a>
| **Stolper-Samuelson Theorem** | A rise in the price of a good raises the return to the factor used intensively in its production and lowers the return to the other factor | [GE 6B.Q2](./answers-ge-game-extern-trade.md#q-edge-02), [EXAM-COMMON-MISTAKES.md](./EXAM-COMMON-MISTAKES.md) |
<a id="term-single-crossing"></a>
| **Single-Crossing Condition** | For Spence signaling: $c'(e, \theta_H) < c'(e, \theta_L)$ — high types find education less costly at the margin; necessary for separating equilibrium | [GE 8.Q4](./answers-ge-game-extern-trade.md#q-extern-04) |
<a id="term-tatonnement"></a>
| **Walrasian Tâtonnement** | Price adjustment process: $\dot{p}_i = k_i \cdot z_i(p)$; prices rise when excess demand $> 0$, fall when $< 0$; stable if $dE/dP < 0$ | [GE 6A.Q2](./answers-ge-game-extern-trade.md#q-ge-02)–[Q3](./answers-ge-game-extern-trade.md#q-ge-03) |
...
<a id="term-giffen"></a>
| **Giffen Good** | Good whose demand curve slopes **up** ($\partial x/\partial p > 0$); large income effect > substitution effect; violates Law of Demand but not rationality | [CT 1B.Q4](./answers-consumer-theory.md#q-cons-1b-04), [EXAM-COMMON-MISTAKES.md](./EXAM-COMMON-MISTAKES.md) |
<a id="term-perfect-substitutes"></a>
| **Perfect Substitutes** | Linear utility $u = a x_1 + b x_2$ or production $q = aK + bL$; $\sigma = \infty$; consumer buys only the cheaper good | [CT 1B.Q8](./answers-consumer-theory.md#q-cons-1b-08), [DP 3A.Q4](./answers-demand-production.md#q-prodset-03) |
<a id="term-cournot"></a>
| **Cournot Competition** | Oligopoly model where firms compete in **quantities**; best-response functions slope down (strategic substitutes); NE at intersection | [GE 7.Q1](./answers-ge-game-extern-trade.md#q-game-01), [EXAM-COMMON-MISTAKES.md](./EXAM-COMMON-MISTAKES.md) |
...
<a id="term-producer-surplus"></a>
| **Producer Surplus (PS)** | Revenue minus (opportunity cost = area below price, above supply/MC); reflects producer gains from trade | [DP 3C.Q1](./answers-demand-production.md#q-compet-01) |
<a id="term-total-surplus"></a>
| **Total Surplus (TS)** | $CS + PS$; maximized at competitive equilibrium; DWL = loss from TS max | [WF Q1](./answers-welfare.md#q-welfare-01)–[Q5](./answers-welfare.md#q-welfare-05) |
<a id="term-potential-compensation"></a>
| **Potential Compensation Principle** | A change is efficient if gainers **could** compensate losers (Hicks-Kaldor); weaker than Pareto | [WF 5B.Q7](./answers-welfare.md#q-pareto-07) |
...
<a id="term-core"></a>
| **Core** | Set of feasible allocations that no coalition can block (improve upon) | [GE 6B.Q1](./answers-ge-game-extern-trade.md#q-edge-01) |
<a id="term-bertrand"></a>
| **Bertrand Competition** | Oligopoly model where firms compete in **prices**; with homogeneous goods → $P = MC$ (zero profit); differentiated goods → positive markups | [DP 3C.Q1](./answers-demand-production.md#q-compet-01), [EXAM-COMMON-MISTAKES.md](./EXAM-COMMON-MISTAKES.md) |
...
| **Free Rider Problem** | Individuals under-contribute to public goods since non-excludable; private provision < efficient level | Government provision, compulsory taxation, Lindahl prices | [GE 8.Q1](./answers-ge-game-extern-trade.md#q-extern-01) |
<a id="term-lindahl"></a>
| **Lindahl Prices** | Personalised tax prices for a public good where each agent pays $t_i$ such that $t_i = MRS_i(G,x)$ and $\sum t_i = MC$; yields efficient provision if agents reveal preferences truthfully | Benefit taxation, Lindahl equilibrium | [basics.md](./basics.md) |
<a id="term-transaction-costs"></a>
| **Transaction Costs** | Costs of search, bargaining, enforcement; Coase Theorem fails when TC > 0; explains existence of firms (Coase) | Legal frameworks, standard contracts | [GE 8.Q2](./answers-ge-game-extern-trade.md#q-extern-02) |
...
| **Concave vs Convex Function** | $f$ concave: $f(\theta x + (1-\theta)y) \ge \theta f(x) + (1-\theta)f(y)$; $f$ convex: $\le$; concave → Hessian NSD (neg. semidef), convex → PSD; concave $\implies$ quasiconcave | [CT 1A.Q9](./answers-consumer-theory.md#q-cons-09) |
<a id="term-quasiconcave"></a>
<a id="term-quasiconvex"></a>
| **Quasiconcave / Quasiconvex Function** | $f$ quasiconcave: upper contour sets $\{x \mid f(x) \ge t\}$ are convex; $f$ quasiconvex: lower contour sets convex; utility functions require quasiconcavity (not concavity); check via bordered Hessian | [CT 1A.Q9](./answers-consumer-theory.md#q-cons-09) |
<a id="term-slater"></a>
| **Slater's Condition** | Constraint qualification: $\exists x$ such that all inequality constraints are strictly satisfied ($g_j(x) < 0$ for non-linear); ensures KKT are necessary at optimum | [CT 1A.Q1](./answers-consumer-theory.md#q-cons-01) |
