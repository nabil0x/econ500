<!-- Extracted from: 501_Microeconomics/501/chapter-2-demand-theory.pdf -->
...
• We denote the solution of the UMP as the 𝐚𝐚𝐚𝐚𝐚𝐚𝐚𝐚𝐚𝐚𝐚𝐚 of
  ...
  problem), and we denote it as 𝑥𝑥(𝑝𝑝, 𝑤𝑤).
   – 𝑥𝑥(𝑝𝑝, 𝑤𝑤) is the Walrasian demand correspondence, which
     specifies a demand of every good in ℝ𝐿𝐿+ for every possible
...
• If the utility function is continuous and preferences
  satisfy LNS over the consumption set 𝑋𝑋 = ℝ𝐿𝐿+ , then the
  Walrasian demand 𝑥𝑥(𝑝𝑝, 𝑤𝑤) satisfies:
   1) Homogeneity of degree zero:
      ...
      That is, the budget set is unchanged!
           𝑥𝑥 ∈ ℝ𝐿𝐿+ : 𝑝𝑝 � 𝑥𝑥 ≤ 𝑤𝑤 = 𝑥𝑥 ∈ ℝ𝐿𝐿+ : 𝛼𝛼𝑝𝑝 � 𝑥𝑥 ≤ 𝛼𝛼𝑤𝑤
...
α p2 p2
                                                        homog(0) would
              x(p,w) is unaffected                      still hold.
...
p2                                                  p2
         ...
         UMP: Necessary Condition
                          max 𝑢𝑢 𝑥𝑥          s. t. 𝑝𝑝 � 𝑥𝑥 ≤ 𝑤𝑤
                          𝑥𝑥≥0
• We solve it using Kuhn-Tucker conditions over the
  Lagrangian 𝐿𝐿 = 𝑢𝑢 𝑥𝑥 + 𝜆𝜆(𝑤𝑤 − 𝑝𝑝 � 𝑥𝑥),
         𝜕𝜕𝐿𝐿     𝜕𝜕𝑢𝑢(𝑥𝑥 ∗ )
               =              − 𝜆𝜆𝑝𝑝𝑘𝑘 ≤ 0 for all 𝑘𝑘, = 0 if 𝑥𝑥𝑘𝑘∗ > 0
        𝜕𝜕𝑥𝑥𝑘𝑘      𝜕𝜕𝑥𝑥𝑘𝑘
        𝜕𝜕𝐿𝐿
               = 𝑤𝑤 − 𝑝𝑝 � 𝑥𝑥 ∗ = 0
        𝜕𝜕𝜕𝜕
                                     𝜕𝜕𝜕𝜕(𝑥𝑥 ∗ )
•   That is, in an interior optimum,             = 𝜆𝜆𝑝𝑝𝑘𝑘 for every
                                       𝜕𝜕𝑥𝑥𝑘𝑘
    good 𝑘𝑘, which implies
           𝜕𝜕𝜕𝜕(𝑥𝑥∗ )                                            𝜕𝜕𝜕𝜕(𝑥𝑥∗ )       𝜕𝜕𝜕𝜕(𝑥𝑥∗ )
             𝜕𝜕𝑥𝑥𝑙𝑙      𝑝𝑝𝑙𝑙             𝑝𝑝𝑙𝑙                     𝜕𝜕𝑥𝑥𝑙𝑙           𝜕𝜕𝑥𝑥𝑘𝑘
           𝜕𝜕𝜕𝜕(𝑥𝑥∗ )   = ⇔ 𝑀𝑀𝑀𝑀𝑀𝑀 𝑙𝑙,𝑘𝑘 = ⇔                                  =
                         𝑝𝑝𝑘𝑘             𝑝𝑝𝑘𝑘                      𝑝𝑝𝑙𝑙            𝑝𝑝𝑘𝑘
             𝜕𝜕𝑥𝑥𝑘𝑘
...
• Kuhn-Tucker
 ...
 1) 𝑢𝑢(𝑥𝑥) is quasiconcave,               w
    i.e., convex upper                    p2
                                                         x * ∈ x (p,w)
    contour set (UCS).
 2) 𝑢𝑢(𝑥𝑥) is monotone.                                             Ind. Curve

 3) 𝛻𝛻𝛻𝛻(𝑥𝑥) ≠ 0 for 𝑥𝑥 ∈ ℝ𝐿𝐿+ .                                           p1
                                                                  slope = - p
    – If 𝛻𝛻𝛻𝛻 𝑥𝑥 = 0 for some 𝑥𝑥,                                           2

      then we would be at the
      “top of the mountain” (i.e.,                       w                       x1
      blissing point), which                             p1
...
2) 𝒖𝒖(�) is not quasiconcave:
  ...
  – 𝑀𝑀𝑀𝑀𝑀𝑀 1,2 =     is not a
    ...
    sufficient condition for a
                                                        C
    max.
  – A point of tangency (C)                                 B
    gives a lower utility level                                      Budget line

    than a point of non-                                        x1
    tangency (B).
  – True maximum is at point
    A.                  Advanced Microeconomic Theory                          17
              UMP: Corner Solution
• Analyzing differential changes in 𝑥𝑥𝑙𝑙 and 𝑥𝑥𝑘𝑘 that keep individual’s
  utility unchanged, 𝑑𝑑𝑑𝑑 = 0,

                  𝑑𝑑𝑑𝑑(𝑥𝑥)          𝑑𝑑𝑑𝑑(𝑥𝑥)
                           𝑑𝑑𝑥𝑥𝑙𝑙 +          𝑑𝑑𝑥𝑥𝑘𝑘 = 0 (total diff.)
                    𝑑𝑑𝑥𝑥𝑙𝑙           𝑑𝑑𝑥𝑥𝑘𝑘
...
• Rearranging,
                         ...
                         𝑑𝑑𝑥𝑥𝑙𝑙    𝑑𝑑𝑑𝑑 𝑥𝑥
                                     𝑑𝑑𝑥𝑥𝑘𝑘
                                                                 𝑑𝑑𝑑𝑑 𝑥𝑥∗       𝑑𝑑𝑑𝑑 𝑥𝑥∗
                                     𝑝𝑝                            𝑑𝑑𝑥𝑥𝑙𝑙         𝑑𝑑𝑥𝑥𝑘𝑘
• Corner Solution: 𝑀𝑀𝑀𝑀𝑀𝑀𝑙𝑙,𝑘𝑘 > 𝑙𝑙 , or alternatively,                     >              , i.e.,
                                𝑝𝑝𝑘𝑘                    𝑝𝑝𝑙𝑙                      𝑝𝑝𝑘𝑘
...
• In the FOCs, this implies:
        𝜕𝜕𝜕𝜕(𝑥𝑥 ∗ )
   a)               ≤ 𝜆𝜆𝑝𝑝𝑘𝑘 for the goods whose consumption is
          𝜕𝜕𝑥𝑥𝑘𝑘
        zero, 𝑥𝑥𝑘𝑘∗ = 0, and
        𝜕𝜕𝜕𝜕(𝑥𝑥 ∗ )
   b)               = 𝜆𝜆𝑝𝑝𝑙𝑙 for the good whose consumption is
           𝜕𝜕𝑥𝑥𝑙𝑙
        positive, 𝑥𝑥𝑙𝑙∗ > 0.
...
• Intuitively, the consumer                                        slope of the I.C. = MRS1,2
...
• 𝜆𝜆 is referred to as the
  “marginal values of relaxing the             x2
  constraint” in the UMP (a.k.a.
  “shadow price of wealth”).

• If we provide more wealth to                w1
                                              p2
  the consumer, he is capable of              w0
                                              p2
  ...
  obtaining a higher utility level.
    ...
    – We want to measure the
      change in utility resulting from                      w0     w1                    x1
                                                            p1     p1
...
• From Walras’ Law, 𝑝𝑝 � 𝑥𝑥 𝑝𝑝, 𝑤𝑤 = 𝑤𝑤, the change in
  expenditure from an increase in wealth is given by
        𝐷𝐷𝑤𝑤 𝑝𝑝 � 𝑥𝑥 𝑝𝑝, 𝑤𝑤 = 𝑝𝑝 � 𝐷𝐷𝑤𝑤 𝑥𝑥 𝑝𝑝, 𝑤𝑤 = 1

• Hence,
   𝛻𝛻𝛻𝛻 𝑥𝑥(𝑝𝑝, 𝑤𝑤) � 𝐷𝐷𝑤𝑤 𝑥𝑥 𝑝𝑝, 𝑤𝑤 = 𝜆𝜆 𝑝𝑝 � 𝐷𝐷𝑤𝑤 𝑥𝑥 𝑝𝑝, 𝑤𝑤 = 𝜆𝜆
                                                         1
...
• An increase in the wealth level
  ...
  the budget line.
                      𝜕𝜕𝑥𝑥2 𝑝𝑝,𝑤𝑤
•   𝑥𝑥2 is normal as                > 0, while
                          𝜕𝜕𝜕𝜕
                      𝜕𝜕𝑥𝑥 𝑝𝑝,𝑤𝑤
    𝑥𝑥1 is inferior as 1            < 0.
                           𝜕𝜕𝜕𝜕
...
• Engel curve depicts the
  ...
  good on the horizontal axis and             Wealth, w

  wealth on the vertical axis.                               Engel curve for a normal good
                                                             (up to income ŵ), but inferior
                                                                   good for all w > ŵ
• The slope of the Engel curve is:
    – positive if the good is normal                                    Engel curve of a normal
                                                                            good, for all w.
...
• If the utility function is continuous and
  ...
  set 𝑋𝑋 = ℝ𝐿𝐿+ , then the indirect utility function
  𝑣𝑣 𝑝𝑝, 𝑤𝑤 satisfies:
...
Properties of Indirect Utility Function
2) Strictly increasing in 𝑤𝑤:                 3) non-increasing (i.e., weakly
                                              decreasing) in 𝑝𝑝𝑘𝑘
...
Properties of Indirect Utility Function
4) Quasiconvex: The set               𝑝𝑝, 𝑤𝑤 : 𝑣𝑣(𝑝𝑝, 𝑤𝑤) ≤ 𝑣𝑣̅ is convex for
any 𝑣𝑣.̅
   - Interpretation I: If (𝑝𝑝1 , 𝑤𝑤 1 ) ≿∗ (𝑝𝑝2 , 𝑤𝑤 2 ), then (𝑝𝑝1 , 𝑤𝑤 1 ) ≿∗ (𝜆𝜆𝜆𝜆1 +
     (1 − 𝜆𝜆)𝑝𝑝2 , 𝜆𝜆𝑤𝑤 1 + (1 − 𝜆𝜆)𝑤𝑤 2 ); i.e., if 𝐴𝐴 ≿∗ 𝐵𝐵, then 𝐴𝐴 ≿∗ 𝐶𝐶.
...
• First, 𝑥𝑥 𝑝𝑝, 𝑤𝑤 and
  𝑥𝑥 𝑝𝑝𝑝, 𝑤𝑤𝑤 are both                   x2
  affordable under 𝐵𝐵𝑝𝑝,𝑤𝑤 .

• Second, 𝑥𝑥 𝑝𝑝, 𝑤𝑤 is not                       Bp,w
  affordable under                     w’               x (p,w)
  𝐵𝐵𝑝𝑝′ ,𝑤𝑤 ′ .                        p’2
...
• Second, 𝑥𝑥 𝑝𝑝, 𝑤𝑤 is                               Bp,w
  affordable under 𝐵𝐵𝑝𝑝′,𝑤𝑤 ′ ,             w’
  i.e., 𝑝𝑝′ � 𝑥𝑥 𝑝𝑝, 𝑤𝑤 < 𝑤𝑤𝑤               p’2


                                                  x (p’,w’ )
• Hence, WARP is NOT                                     x (p,w)        Bp’,w’
...
• Totally differentiating 𝑥𝑥 𝑝𝑝, 𝑤𝑤 ,
           𝑑𝑑𝑑𝑑 = 𝐷𝐷𝑝𝑝 𝑥𝑥 𝑝𝑝, 𝑤𝑤 𝑑𝑑𝑑𝑑 + 𝐷𝐷𝑤𝑤 𝑥𝑥 𝑝𝑝, 𝑤𝑤 𝑑𝑑𝑤𝑤
...
𝑑𝑑𝑑𝑑 = 𝐷𝐷𝑝𝑝 𝑥𝑥 𝑝𝑝, 𝑤𝑤 𝑑𝑑𝑑𝑑 + 𝐷𝐷𝑤𝑤 𝑥𝑥 𝑝𝑝, 𝑤𝑤 𝑥𝑥(𝑝𝑝, 𝑤𝑤) � 𝑑𝑑𝑑𝑑
                                                      𝑑𝑑𝑑𝑑
or equivalently,

  𝑑𝑑𝑑𝑑 = 𝐷𝐷𝑝𝑝 𝑥𝑥 𝑝𝑝, 𝑤𝑤 + 𝐷𝐷𝑤𝑤 𝑥𝑥 𝑝𝑝, 𝑤𝑤 𝑥𝑥(𝑝𝑝, 𝑤𝑤)𝑇𝑇 𝑑𝑑𝑑𝑑


                      Advanced Microeconomic Theory             60
   Implications of WARP: Slutsky Matrix
• Hence the law of demand, 𝑑𝑑𝑑𝑑 � 𝑑𝑑𝑑𝑑 ≤ 0, can be expressed as
         𝑑𝑑𝑑𝑑 � 𝐷𝐷𝑝𝑝 𝑥𝑥 𝑝𝑝, 𝑤𝑤 + 𝐷𝐷𝑤𝑤 𝑥𝑥 𝑝𝑝, 𝑤𝑤 𝑥𝑥(𝑝𝑝, 𝑤𝑤)𝑇𝑇 𝑑𝑑𝑑𝑑 ≤ 0
                                            𝑑𝑑𝑑𝑑
   ...
   where each element in the matrix is
                            ...
                            𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝, 𝑤𝑤) 𝜕𝜕𝑥𝑥𝑙𝑙 𝑝𝑝, 𝑤𝑤
            𝑠𝑠𝑙𝑙𝑙𝑙 𝑝𝑝, 𝑤𝑤 =                +              𝑥𝑥𝑘𝑘 (𝑝𝑝, 𝑤𝑤)
                                 𝜕𝜕𝑝𝑝𝑘𝑘           𝜕𝜕𝑤𝑤
...
• Non-positive substitution effect, 𝑠𝑠𝑙𝑙𝑙𝑙 ≤ 0:
                                ...
                                𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝, 𝑤𝑤)   𝜕𝜕𝑥𝑥𝑙𝑙 𝑝𝑝, 𝑤𝑤
          𝑠𝑠𝑙𝑙𝑙𝑙 𝑝𝑝, 𝑤𝑤       =                 +               𝑥𝑥𝑙𝑙 (𝑝𝑝, 𝑤𝑤)
                                     𝜕𝜕𝑝𝑝𝑙𝑙             𝜕𝜕𝜕𝜕
    substitution effect (−)
                                    Total effect:             Income effect:
                                   − usual good               + normal good
...
•   Reduction in the price of 𝑥𝑥1 .
     ...
     – He can reach an indifference curve
       further away from the origin.                                B
                                                                             I2


•   The Walrasian demand curve indicates                                I1


    that a decrease in the price of 𝑥𝑥1 leads
    to an increase in the quantity                                      X1


    demanded.
     – This induces a negatively sloped               p1
...
•   Reduce the consumer’s wealth so that he                                   B
                                                                                                     I2

    can afford the same consumption bundle                                                          I3

    as the one before the price change (i.e., A).                                              I1

     – Shift the budget line after the price change                                                 x1
       inwards until it “crosses” through the initial
       bundle A.
     – “Constant purchasing power” demand                   p1
       curve (CPP curve) results from applying the
       Slutsky wealth compensation.                         p1        a
     – The quantity demanded for 𝑥𝑥1 increases
       from 𝑥𝑥10 to 𝑥𝑥13 .

•   When we do not hold the consumer’s                                    c   b

    purchasing power constant, we observe
    relatively large increase in the quantity                                     CPP demand
    demanded for 𝑥𝑥1 (i.e., from 𝑥𝑥10 to 𝑥𝑥12 ).
                                                                                                    x1
...
•   The consumer’s wealth level is adjusted
    ...
    level (i.e., the same indifference curve 𝐼𝐼1                                               I3
    as before the price change).                                                          I1

     – A more significant wealth reduction than
       when we apply the Slutsky wealth                                                        x1

       compensation.
     – The Hicksian demand curve reflects that, for
       a given decrease in p1, the consumer slightly          p1
       increases his consumption of good one.
                                                              p1
•   In summary, a given decrease in 𝑝𝑝1
    produces:
     – A small increase in the Hicksian demand for
       the good, i.e., from 𝑥𝑥10 to 𝑥𝑥11 .
     – A larger increase in the CPP demand for the
       good, i.e., from 𝑥𝑥10 to 𝑥𝑥13 .                                     CPP demand
     – A substantial increase in the Walrasian                          Hicksian demand
       demand for the product, i.e., from 𝑥𝑥10 to 𝑥𝑥12 .                                       x1
                                        Advanced Microeconomic Theory                                68
  Implications of WARP: Slutsky Equation
• A decrease in price of 𝑥𝑥1 leads the consumer to
...
• The substitution effect (SE)
  moves in the opposite direction                            BL2

  as the price change.                        BL      1

    – A reduction in the price of
      food implies a positive
                                                                                      C
      substitution effect.                          BLd
                                                                   A
                                                                                                    I2
• The income effect (IE) is                                             B
...
• The income effect (IE) is now
  ...
  quantity demanded associated                                         I1
  with the SE).                                            BL1   BLd

     – The good is inferior.
• Note: the SE is larger than the
  IE.                      Advanced Microeconomic Theory                71
      Substitution and Income Effects:
                Giffen Goods
• Decrease in the price of the
  good in the horizontal axis (i.e.,
...
• The income effect (IE) is still
  ...
  offsets the increase in the
  quantity demanded associated                               BL1
                                                                   I1        BL2
...
• Consumer seeks a utility level
  ...
  indifference curve, while                  X2
  spending as little as possible.
• Bundles strictly above 𝑥𝑥 ∗ cannot
  be a solution to the EMP:                                     UCS(x*)
...
• That is, the slope of indifference curve is equal to the slope
  of the budget line. Advanced Microeconomic Theory             79
         EMP: Hicksian Demand
...
• Suppose that 𝑢𝑢(�) is a continuous function,
  satisfying LNS defined on 𝑋𝑋 = ℝ𝐿𝐿+ . Then for 𝑝𝑝 ≫
  0, ℎ(𝑝𝑝, 𝑢𝑢) satisfies:
...
• Spend more to buy bundle
  𝑥𝑥 ∗ (𝑥𝑥1∗ , 𝑥𝑥2∗ ), i.e.,
      𝑝𝑝1′ 𝑥𝑥1∗ + 𝑝𝑝2′ 𝑥𝑥2∗ > 𝑝𝑝1 𝑥𝑥1∗ + 𝑝𝑝2 𝑥𝑥2∗                       x1
...
• Compensated Law of Demand: for any change
  ...
  – Implication: for every good 𝑘𝑘,
      (𝑝𝑝𝑘𝑘′ − 𝑝𝑝𝑘𝑘 ) � ℎ𝑘𝑘 𝑝𝑝′ , 𝑢𝑢 − ℎ𝑘𝑘 𝑝𝑝, 𝑢𝑢 ≤ 0
...
• Suppose that 𝑢𝑢(�) is a continuous function, satisfying
  LNS defined on 𝑋𝑋 = ℝ𝐿𝐿+ . Then for 𝑝𝑝 ≫ 0, 𝑒𝑒(𝑝𝑝, 𝑢𝑢)
  satisfies:

   1) Homog(1) in 𝑝𝑝,
            𝑒𝑒 𝛼𝛼𝛼𝛼, 𝑢𝑢 = 𝛼𝛼 𝑝𝑝 � 𝑥𝑥 ∗ = 𝛼𝛼 � 𝑒𝑒(𝑝𝑝, 𝑢𝑢)
                                        𝑒𝑒(𝑝𝑝,𝑢𝑢)
...
2) Strictly increasing in 𝒖𝒖:
   For a given price vector,                   x2
   reaching a higher utility
   requires higher
   expenditure:
   𝑝𝑝1 𝑥𝑥1′ + 𝑝𝑝2 𝑥𝑥2′ > 𝑝𝑝1 𝑥𝑥1 + 𝑝𝑝2 𝑥𝑥2

    where (𝑥𝑥1 , 𝑥𝑥2 ) = ℎ(𝑝𝑝, 𝑢𝑢)              x2
    and (𝑥𝑥1′ , 𝑥𝑥2′ ) = ℎ(𝑝𝑝, 𝑢𝑢′ ).
...
3) Non-decreasing in 𝒑𝒑𝒌𝒌 for every good 𝒌𝒌:
   ...
   given utility level.
   • Let 𝑝𝑝′ = (𝑝𝑝1 , 𝑝𝑝2 , … , 𝑝𝑝𝑘𝑘′ , … , 𝑝𝑝𝐿𝐿 ) and 𝑝𝑝 =
      (𝑝𝑝1 , 𝑝𝑝2 , … , 𝑝𝑝𝑘𝑘 , … , 𝑝𝑝𝐿𝐿 ), where 𝑝𝑝𝑘𝑘′ > 𝑝𝑝𝑘𝑘 .
 ...
 Properties of Expenditure Function                                            x2



4)      Concave in 𝒑𝒑:                                                 w / p2 ''

Let 𝑥𝑥 ′ ∈ ℎ 𝑝𝑝′ , 𝑢𝑢 ⇒ 𝑝𝑝′ 𝑥𝑥 ′ ≤ 𝑝𝑝′ 𝑥𝑥                                w / p2
∀𝑥𝑥 ≠ 𝑥𝑥 ′ , e.g., 𝑝𝑝′ 𝑥𝑥 ′ ≤ 𝑝𝑝′ 𝑥𝑥̅                                               x’’
and
𝑥𝑥 ′′ ∈ ℎ 𝑝𝑝′′ , 𝑢𝑢 ⇒ 𝑝𝑝′′ 𝑥𝑥 ′′ ≤ 𝑝𝑝′′ 𝑥𝑥                               w / p2 '
                                                                                          x
∀𝑥𝑥 ≠ 𝑥𝑥 ′′ , e.g., 𝑝𝑝′′ 𝑥𝑥 ′′ ≤ 𝑝𝑝′′ 𝑥𝑥̅
where 𝑥𝑥̅ = 𝛼𝛼𝑥𝑥 ′ + 1 − 𝛼𝛼 𝑥𝑥𝑥𝑥                                                                    x’
                                                                                                                   u
This implies
         𝛼𝛼𝑝𝑝′ 𝑥𝑥 ′ + 1 − 𝛼𝛼 𝑝𝑝′′ 𝑥𝑥 ′′ ≤ 𝛼𝛼𝑝𝑝′ 𝑥𝑥̅ + 1 − 𝛼𝛼 𝑝𝑝′′ 𝑥𝑥̅                                                             x1
                                                                                              w / p1 ''   w / p1       w / p1 '
           𝑒𝑒(𝑝𝑝′ ,𝑢𝑢)             𝑒𝑒(𝑝𝑝′′ ,𝑢𝑢)
             �
         𝛼𝛼 𝑝𝑝′ 𝑥𝑥 ′ +   1 − 𝛼𝛼     𝑝𝑝′′ 𝑥𝑥 ′′ ≤ [𝛼𝛼𝑝𝑝′ +   1 − 𝛼𝛼 𝑝𝑝′′ ]𝑥𝑥̅
                                                            𝑝𝑝̅


                𝛼𝛼𝛼𝛼(𝑝𝑝′ , 𝑢𝑢) + 1 − 𝛼𝛼 𝑒𝑒(𝑝𝑝′′ , 𝑢𝑢) ≤ 𝑒𝑒(𝑝𝑝,̅ 𝑢𝑢)
...
• Let’s assume that 𝑢𝑢(�) is a continuous function,
  ...
  strictly convex and defined on 𝑋𝑋 = ℝ𝐿𝐿+ . For all 𝑝𝑝 and 𝑢𝑢,
            𝜕𝜕𝑒𝑒 𝑝𝑝,𝑢𝑢
...
• The relationship between the Hicksian demand and the
  ...
  first order conditions again. That is,
                     𝜕𝜕 2 𝑒𝑒(𝑝𝑝, 𝑢𝑢) 𝜕𝜕ℎ𝑘𝑘 (𝑝𝑝, 𝑢𝑢)
                               2     =
                          𝜕𝜕𝑝𝑝𝑘𝑘           𝜕𝜕𝑝𝑝𝑘𝑘
  or
                     𝐷𝐷𝑝𝑝2 𝑒𝑒 𝑝𝑝, 𝑢𝑢 = 𝐷𝐷𝑝𝑝 ℎ(𝑝𝑝, 𝑢𝑢)
• Since 𝐷𝐷𝑝𝑝 ℎ(𝑝𝑝, 𝑢𝑢) provides the Slutsky matrix, 𝑆𝑆(𝑝𝑝, 𝑤𝑤), then
                       𝑆𝑆 𝑝𝑝, 𝑤𝑤 = 𝐷𝐷𝑝𝑝2 𝑒𝑒 𝑝𝑝, 𝑢𝑢
...
• There are three other important properties of
  𝐷𝐷𝑝𝑝 ℎ(𝑝𝑝, 𝑢𝑢), where 𝐷𝐷𝑝𝑝 ℎ(𝑝𝑝, 𝑢𝑢) is 𝐿𝐿 × 𝐿𝐿 derivative
  matrix of the Hicksian demand, ℎ 𝑝𝑝, 𝑢𝑢 :
   1) 𝐷𝐷𝑝𝑝 ℎ(𝑝𝑝, 𝑢𝑢) is negative semidefinite
         Hence, 𝑆𝑆 𝑝𝑝, 𝑤𝑤 is negative semidefinite.
   2) 𝐷𝐷𝑝𝑝 ℎ(𝑝𝑝, 𝑢𝑢) is a symmetric matrix
         Hence, 𝑆𝑆 𝑝𝑝, 𝑤𝑤 is symmetric.
   3) 𝐷𝐷𝑝𝑝 ℎ 𝑝𝑝, 𝑢𝑢 𝑝𝑝 = 0, which implies 𝑆𝑆 𝑝𝑝, 𝑤𝑤 𝑝𝑝 = 0.
                                                        𝜕𝜕ℎ (𝑝𝑝,𝑢𝑢)
         Not all goods can be net complements         𝑙𝑙
                                                             <0 .
                                                      𝜕𝜕𝑝𝑝𝑘𝑘
...
• When income effects
  ...
  ℎ(𝑝𝑝, 𝑢𝑢) .
   ...
   – The Hicksian demand                            p1


     is steeper than the                      ∇p1
                                                    p’1
...
• We can formally relate the Hicksian and Walrasian
  demand as follows:
   – Consider 𝑢𝑢(�) is a continuous function, representing
     ...
     defined on 𝑋𝑋 = ℝ𝐿𝐿+ .
   – Consider a consumer facing (𝑝𝑝,̅ �          𝑤𝑤) and attaining utility
     level 𝑢𝑢� .
   – Note that 𝑤𝑤  � = 𝑒𝑒(𝑝𝑝,̅ 𝑢𝑢� ). In addition, we know that for any
     (𝑝𝑝, 𝑢𝑢), ℎ𝑙𝑙 𝑝𝑝, 𝑢𝑢 = 𝑥𝑥𝑙𝑙 (𝑝𝑝, 𝑒𝑒 𝑝𝑝, 𝑢𝑢 ). Differentiating this
                                                𝑤𝑤
     expression with respect to 𝑝𝑝𝑘𝑘 , and evaluating it at (𝑝𝑝,̅ 𝑢𝑢� ),
     we get:
      𝜕𝜕ℎ𝑙𝑙 (𝑝𝑝,̅ 𝑢𝑢� ) 𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝,̅ 𝑒𝑒(𝑝𝑝,̅ 𝑢𝑢� )) 𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝,̅ 𝑒𝑒(𝑝𝑝,̅ 𝑢𝑢� )) 𝜕𝜕𝜕𝜕(𝑝𝑝,̅ 𝑢𝑢� )
                       =                           +
         𝜕𝜕𝑝𝑝𝑘𝑘                  𝜕𝜕𝑝𝑝𝑘𝑘                       𝜕𝜕𝜕𝜕                 𝜕𝜕𝑝𝑝𝑘𝑘
    ...
    Relationship between Hicksian and
            Walrasian Demand
                      𝜕𝜕𝑒𝑒(𝑝𝑝,̅ 𝑢𝑢
                                �)
• Using the fact that              = ℎ𝑘𝑘 (𝑝𝑝,̅ 𝑢𝑢� ),
                         𝜕𝜕𝑝𝑝𝑘𝑘
                ̅ 𝑢𝑢)
       𝜕𝜕ℎ𝑙𝑙 (𝑝𝑝,�                ̅ 𝑝𝑝,�
                        𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝,𝑒𝑒(  ̅ 𝑢𝑢))             ̅ 𝑝𝑝,�
                                                 𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝,𝑒𝑒( ̅ 𝑢𝑢))
                      =                        +                       ℎ𝑘𝑘 (𝑝𝑝,̅ 𝑢𝑢� )
          𝜕𝜕𝑝𝑝𝑘𝑘                 𝜕𝜕𝑝𝑝𝑘𝑘                   𝜕𝜕𝜕𝜕

• Finally, since 𝑤𝑤    � = 𝑒𝑒(𝑝𝑝,̅ 𝑢𝑢� ) and ℎ𝑘𝑘 𝑝𝑝,̅ 𝑢𝑢� =
                                     � , then
  𝑥𝑥𝑘𝑘 𝑝𝑝,̅ 𝑒𝑒 𝑝𝑝,̅ 𝑢𝑢� = 𝑥𝑥𝑘𝑘 𝑝𝑝,̅ 𝑤𝑤
             𝜕𝜕ℎ𝑙𝑙 ( ̅
                    𝑝𝑝,�
                       𝑢𝑢)   𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝,̅ �
                                          𝑤𝑤)   𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝,̅ �
...
• But this coincides with 𝑠𝑠𝑙𝑙𝑘𝑘 𝑝𝑝, 𝑤𝑤 that we
  discussed in the Slutsky equation.
   – Hence, we have 𝐷𝐷𝑝𝑝 ℎ 𝑝𝑝, 𝑢𝑢 = 𝑆𝑆 𝑝𝑝, 𝑤𝑤 .
                              𝐿𝐿×𝐿𝐿
...
• Finally, we can also use:
    – The Slutsky equation:
              𝜕𝜕ℎ𝑙𝑙 (𝑝𝑝, 𝑢𝑢) 𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝, 𝑤𝑤) 𝜕𝜕𝑥𝑥𝑙𝑙 (𝑝𝑝, 𝑤𝑤)
                            =               +                𝑥𝑥𝑘𝑘 (𝑝𝑝, 𝑤𝑤)
                 𝜕𝜕𝑝𝑝𝑘𝑘            𝜕𝜕𝑝𝑝𝑘𝑘           𝜕𝜕𝜕𝜕
...
v(p,w)                                    e(p,u)
          ...
          Advanced Microeconomic Theory             111
           Summary of Relationships
           The UMP      4(a) Slutsky                 The EMP
                          equation
           x(p,w)    (Using derivatives)             h(p,u)

                        3(a)            3(b)
 4(b)                                                            4(c)
 Roy’s      (1)                                          (1)   Shephard’s
Identity                                                        Lemma
...
• Similarly, we also require
  that the function 𝑀𝑀(𝑡𝑡)
  satisfies continuity.                Distance                        M(t)
• Otherwise: the maximal
  distance that the turtle can
  travel in time 𝑡𝑡 ∗ is 𝑥𝑥2 ,
  whereas the minimum time                x2
                                                           Jumping turtle
  required to travel distance             x1
  𝑥𝑥1 and 𝑥𝑥2 is 𝑡𝑡 ∗ for both
  distances.
• Hence, a non-continuous
  function does not guarantee                         t*                      Time, t
...
• Given 𝑢𝑢(�) is monotonic and continuous, then if
  𝑥𝑥 ∗ is the solution to the problem
              max 𝑢𝑢(𝑥𝑥) s.t. 𝑝𝑝 � 𝑥𝑥 ≤ 𝑤𝑤            (UMP)
               𝑥𝑥≥0

  it must also be a solution to the problem
            min 𝑝𝑝 � 𝑥𝑥 s.t. 𝑢𝑢 𝑥𝑥 ≥ 𝑢𝑢               (EMP)
             𝑥𝑥≥0
           ...
           Hyperplane Theorem
• Hyperplane: for some
  𝑝𝑝 ∈ ℝ𝐿𝐿+ and 𝑐𝑐 ∈ ℝ, the                Half-space
...
• Separating hyperplane theorem: For every
  ...
  containing 𝐾𝐾 and excluding any point 𝑥𝑥̅ ∉ 𝐾𝐾
  outside of this set.
   – That is, there exist 𝑝𝑝 ∈ ℝ𝐿𝐿+ and 𝑐𝑐 ∈ ℝ such that
         𝑝𝑝 � 𝑥𝑥 ≥ 𝑐𝑐 for all elements in the set, 𝑥𝑥 ∈ 𝐾𝐾
         𝑝𝑝 � 𝑥𝑥̅ < 𝑐𝑐 for all elements outside the set, 𝑥𝑥̅ ∉ 𝐾𝐾
...
• For every nonempty closed set 𝐾𝐾 ⊂ ℝ𝐿𝐿 , its support
  function is defined by
         𝜇𝜇𝐾𝐾 𝑝𝑝 = inf𝑥𝑥 𝑝𝑝 � 𝑥𝑥 for all 𝑥𝑥 ∈ 𝐾𝐾 and 𝑝𝑝 ∈ ℝ𝐿𝐿+
...
• From the support function of 𝐾𝐾, we can reconstruct 𝐾𝐾.
   – In particular, for every 𝑝𝑝 ∈ ℝ𝐿𝐿+ , we can define half-spaces
     whose boundary is the support function of set 𝐾𝐾.
       That is, we define the set of bundles for which 𝑝𝑝 � 𝑥𝑥 ≥ 𝜇𝜇𝐾𝐾 𝑝𝑝 . Note
        ...
        𝐾𝐾, but does not contain elements outside 𝐾𝐾, i.e., 𝑥𝑥̅ ∉ 𝐾𝐾 .
...
• The above definition of the support function provides
  us with a useful duality theorem:
   – Let 𝐾𝐾 be a nonempty, closed set, and let 𝜇𝜇𝐾𝐾 � be its
     support function. Then there is a unique element in 𝐾𝐾, 𝑥𝑥̅ ∈
     𝐾𝐾, such that, for all price vector 𝑝𝑝,̅
         𝑝𝑝̅ � 𝑥𝑥̅ = 𝜇𝜇𝐾𝐾 𝑝𝑝̅ ⇔ 𝜇𝜇𝐾𝐾 � is differentiable at 𝑝𝑝̅
...
•   The expenditure function is the support function for the set of all bundles
    in ℝ𝐿𝐿+ for which utility reaches at least a level of 𝑢𝑢. That is,
                                    𝑥𝑥 ∈ ℝ𝐿𝐿+ : 𝑢𝑢(𝑥𝑥) ≥ 𝑢𝑢
...
• Totally differentiating the expenditure function 𝑒𝑒 𝑝𝑝, 𝑢𝑢 ,
                                                                               𝑇𝑇
       𝛻𝛻𝑝𝑝 𝑒𝑒 𝑝𝑝, 𝑢𝑢 = 𝛻𝛻𝑝𝑝 𝑝𝑝 � ℎ(𝑝𝑝, 𝑢𝑢) = ℎ 𝑝𝑝, 𝑢𝑢 + 𝑝𝑝 � 𝐷𝐷𝑝𝑝 ℎ(𝑝𝑝, 𝑢𝑢)

• And, from the FOCs in interior solutions of the EMP, we know that
  𝑝𝑝 = 𝜆𝜆𝜆𝜆𝜆𝜆(ℎ 𝑝𝑝, 𝑢𝑢 ). Substituting,

          𝛻𝛻𝑝𝑝 𝑒𝑒 𝑝𝑝, 𝑢𝑢 = ℎ 𝑝𝑝, 𝑢𝑢 + 𝜆𝜆[𝛻𝛻𝛻𝛻(ℎ 𝑝𝑝, 𝑢𝑢 ) � 𝐷𝐷𝑝𝑝 ℎ(𝑝𝑝, 𝑢𝑢)]𝑇𝑇
...
• Consider a sequence of prices 𝑝𝑝𝑡𝑡 where 𝑡𝑡 =
  ...
  bundles 𝑥𝑥 𝑡𝑡 .
• GARP: If bundle 𝑥𝑥 𝑡𝑡 is revealed preferred to 𝑥𝑥 𝑡𝑡+1
  for all 𝑡𝑡 = 1,2, … , 𝑇𝑇, i.e., 𝑥𝑥 1 ≿ 𝑥𝑥 2 , 𝑥𝑥 2 ≿
  𝑥𝑥 3 , … , 𝑥𝑥 𝑇𝑇−1 ≿ 𝑥𝑥 𝑇𝑇 , then 𝑥𝑥 𝑇𝑇 is not strictly revealed
  preferred to 𝑥𝑥 1 , i.e., 𝑥𝑥 𝑇𝑇 ⊁ 𝑥𝑥 1 .
   ...
   – Some choices satisfy GARP, some WARP, choices for
     which both axioms hold, and some for which none do.
                       ...
                       GARP
• Choices satisfying GARP, WARP, both, or none
...
• Example A2.3 (continued):
  ...
  – Hence, GARP is satisfied.
                      ...
                      Advanced Microeconomic Theory             151
                         GARP
• Example A2.4 (Neither WARP nor GARP hold):
  – Consider the following sequence of price vectors
    and their corresponding demanded bundles
             𝑝𝑝1 = (1,1,1) 𝑥𝑥1 = (1,0,0)
             𝑝𝑝2 = (1,2,1) 𝑥𝑥2 = (0,1,0)
...
• Example A2.4 (continued):
  ...
  – Hence, neither WARP nor GARP hold in this case.
                   ...
                   Advanced Microeconomic Theory      153
                            GARP
• GARP constitutes a sufficient condition for utility
  maximization.
• That is, if the sequence of price-bundle pairs
  (𝑝𝑝𝑡𝑡 , 𝑥𝑥 𝑡𝑡 ) satisfies GARP, then it must originate
  from a utility maximizing consumer.
• We refer to (𝑝𝑝𝑡𝑡 , 𝑥𝑥 𝑡𝑡 ) as a set of “data.”



                       Advanced Microeconomic Theory       154
                                GARP
• Afriat’s theorem. For a sequence of price-bundle
  pairs (𝑝𝑝𝑡𝑡 , 𝑥𝑥 𝑡𝑡 ), the following statements are
  equivalent:
   ...
   3) There exist positive numbers (𝑢𝑢𝑡𝑡 , 𝜆𝜆𝑡𝑡 ) for all 𝑡𝑡 =
      1,2, … , 𝑇𝑇 that satisfy the Afriat inequalities
              𝑢𝑢𝑡𝑡 ≤ 𝑢𝑢 𝑠𝑠 + 𝜆𝜆𝑠𝑠 𝑝𝑝 𝑠𝑠 (𝑥𝑥 𝑡𝑡 − 𝑥𝑥 𝑠𝑠 ) for all 𝑠𝑠, 𝑡𝑡
   4) The data can rationalized by a continuous, concave,
      and strongly monotonic utility function.
                           ...
                           Advanced Microeconomic Theory                  155
                               GARP
• A data set is “rationalized” by a utility function if:
   – for every pair (𝑝𝑝𝑡𝑡 , 𝑥𝑥 𝑡𝑡 ), bundle 𝑥𝑥 𝑡𝑡 yields a higher utility
     than any other feasible bundle x, i.e., 𝑢𝑢(𝑥𝑥 𝑡𝑡 ) ≥ 𝑢𝑢(𝑥𝑥)
     for all 𝑥𝑥 in budget set 𝐵𝐵(𝑝𝑝𝑡𝑡 , 𝑝𝑝𝑡𝑡 𝑥𝑥 𝑡𝑡 ).
   ...
   – That is, the utility function satisfies LNS, continuity,
     concavity, and strong monotonicity.
                          ...
                          Advanced Microeconomic Theory                156
                             GARP
• Condition (3) in Afriat’s Theorem has a concavity
  interpretation:
  – From FOCs, we have 𝐷𝐷𝐷𝐷 𝑥𝑥 𝑡𝑡 = 𝜆𝜆𝑡𝑡 𝑝𝑝𝑡𝑡 .
  – By concavity,
                     𝑢𝑢 𝑥𝑥 𝑡𝑡 −𝑢𝑢(𝑥𝑥 𝑠𝑠 )
                                            ≤ 𝑢𝑢′ (𝑥𝑥 𝑠𝑠 )
                          𝑥𝑥 𝑡𝑡 −𝑥𝑥 𝑠𝑠
  – Or, re-arranging,
        𝑢𝑢 𝑥𝑥 𝑡𝑡 ≤ 𝑢𝑢 𝑥𝑥 𝑠𝑠 + 𝑢𝑢′ (𝑥𝑥 𝑠𝑠 )(𝑥𝑥 𝑡𝑡 − 𝑥𝑥 𝑠𝑠 )
  – Since 𝑢𝑢′ 𝑥𝑥 𝑠𝑠 = 𝜆𝜆𝑠𝑠 𝑝𝑝 𝑠𝑠 , it can be expressed as
    Afriat’s inequality
         𝑢𝑢 𝑥𝑥 𝑡𝑡 ≤ 𝑢𝑢 𝑥𝑥 𝑠𝑠 + 𝜆𝜆𝑠𝑠 𝑝𝑝 𝑠𝑠 (𝑥𝑥 𝑡𝑡 − 𝑥𝑥 𝑠𝑠 )
